...
#
# Run: mpiexec -n 2 python3 jacobi_insitu_parallel_Catalyst.py
#
...
def main():
    ...
    sim = ParallelSimulation_With_Catalyst(meshtype="uniform", iterations=5000, pv_script="../JacobiC++/catalyst_state.py")
    sim.initialize()
    sim.main_loop()
